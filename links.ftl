...
<@layout title="链接 | ${blog_title!}">
    ...
    <link rel="stylesheet" href="${theme_base!}/templates/assets/css/links.css">
    <style>
        /* 链接分类、链接鼠标划过字体颜色 */
...
<#--这个列表初始化隐藏，用JS来做显示操作-->
    <#include "templates/module/links/hide_list.ftl"/>
    ...
    <div class="container px-md-2 px-3 pt-3 bg-white">
        <div id="linkBox" style="display: none;" class="row py-3">
            ...
            <div id="left" class="col-md-3 mb-4">
                <#include "templates/module/links/left.ftl">
            </div>
            <div id="right" class="col-md-9 mt-md-0 mt-3">
                <#include "templates/module/links/right.ftl">
            </div>
        </div>
...
<script src="${theme_base!}/templates/assets/js/links.js"></script>